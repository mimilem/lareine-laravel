...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 03 fév. 2022 à 06:06
...
--
-- Base de données : `lasouveraine_db`
--
...
--
-- Structure de la table `facilitators`
--
...
(5, '2022_01_31_104919_create_subscribes_table', 1),
(6, '2022_01_31_111326_create_courses_table', 1),
(7, '2022_01_31_114233_create_facilitators_table', 1);
...
ALTER TABLE `courses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `courses_subtitle_unique` (`subtitle`),
  ADD UNIQUE KEY `courses_token_unique` (`token`);

--
-- Index pour la table `facilitators`
--
...
--
-- AUTO_INCREMENT pour la table `facilitators`
--
ALTER TABLE `facilitators`
