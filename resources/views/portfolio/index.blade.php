    ...
    <div class="row medium-padding120">
        <div class="col-lg-12">
            <div class="heading align-center">
                <h4 class="h1 heading-title">Nos réalisations</h4>
            </div>
            
            <div class="row pt80" data-layout="fitRows">
                @foreach ($projects as $project)
                    <a href="{{ route('project_details', ['token' => $project['token']]) }}" class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
