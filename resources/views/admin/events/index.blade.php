                              ...
                              <div class="modal-body">
                                 <div class="form-group row">
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                         ...
                                         <input type="text" name="title" placeholder="Nom de l'evenement" class="form-control">
                                     </div>
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                         <label>Sous-titre de l'evenement</label>
                                         <input type="text" name="subtitle" required placeholder="Sous-titre de l'evenement" class="form-control">
                                     </div>
                                 </div>
                                 <div class="form-group row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <label for="exampleSelect1" class="form-control-label">Type d'Evenement</label>
                                        <select class="form-control " name="activity_type" id="exampleSelect1">
                                 ...
                                 <div class="form-group row">
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                         <label>Prix de l'evenement</label>
