		...
		<div class="container">
			<div class="top-bar-contact">
				<div class="contact-item">
					<a href="mailto:lasouveraine@lasouveraine.marketing" >lasouveraine@lasouveraine.marketing</a>
				</div>
					...
					<div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12">
						<div class="services">
							...
							<ul class="list list--primary">
								...
								<li>
									<i class="fa fa-caret-right" aria-hidden="true"></i>
									<a href="{{ route('sales_representation') }}">Représentations Commerciales</a>
								</li>
							</ul>
